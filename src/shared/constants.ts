...
export const ANALYSIS_IDLE_TIMEOUT_MS = 5_000
export const AUTOMATIC_ANALYSIS_MAX_ELEMENT_COUNT = 2_500
export const AUTOMATIC_ANALYSIS_MAX_MUTATION_NODE_COUNT = 80
